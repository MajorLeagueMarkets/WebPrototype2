...
//if user is already logge din, kick them and dont let them login again
...
if ( isset($_POST["username"]) && isset($_POST["password"]) ) {
	...
	//if all cases pass then loigin is successful - redirect to home page
...
<body>
		...
		<div class="container">
			...
			<div class="container">
				...
				<div class="col-sm-12 newUser"> <a href="signUp.php"> <strong>New user? Sign up here! </strong></a></div>
				<div class="col-sm-12 newUser"> <a href="deleteUser.php"> <strong>Delete user? Click here! </strong></a></div>
			</div> <!-- .container -->
